      ...
      <li
        ...
        className={cn(timelineItemVariants({ variant }), className, {
          "[&_.tm-separator]:right-0 [&_.tm-separator]:left-[unset]  [&_.tm-content-wrapper]:text-right [&_.tm-content-wrapper]:pr-8":
            position === "left",
          "[&_.tm-separator]:left-0 [&_.tm-content-wrapper]:pl-8 rtl:[&_.tm-separator]:right-0 rtl:[&_.tm-separator]:left-[unset]  rtl:[&_.tm-content-wrapper]:text-right rtl:[&_.tm-content-wrapper]:pr-8":
