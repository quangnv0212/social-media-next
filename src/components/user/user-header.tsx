    ...
    <Fragment>
      <Card className="mt-6 rounded-t-2xl ">
        <CardContent className="p-0">
          <div
            className="relative h-[200px] lg:h-[296px] rounded-t-2xl w-full object-cover bg-cover bg-no-repeat"
            style={{
              backgroundImage: `url(https://loremflickr.com/640/480?lock=1234)`,
            }}
          >
